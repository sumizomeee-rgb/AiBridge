...
WEB_SOURCE_PRIORITY = ("web-deepseek", "web-qwen", "web-doubao", "web-kimi", "web-perplexity", "web-wenxin", "web-yuanbao")
SUPPORTED_WEB_PROTOCOLS = {"deepseek_web", "qwen_web", "doubao_web", "kimi_web", "perplexity_web", "wenxin_web"}
