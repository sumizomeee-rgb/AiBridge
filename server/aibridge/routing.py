...
WEB_SOURCE_PRIORITY = ("web-deepseek", "web-qwen", "web-doubao", "web-kimi", "web-perplexity", "web-wenxin", "web-longcat", "web-mimo", "web-yuanbao")
SUPPORTED_WEB_PROTOCOLS = {"deepseek_web", "qwen_web", "doubao_web", "kimi_web", "perplexity_web", "wenxin_web", "longcat_web", "mimo_web"}
